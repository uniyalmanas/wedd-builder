...
export default function Services() {
  const { data, editMode, updateSection, setSelectedPackage, setCheckoutOpen } = usePortfolioData();
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between border-t border-charcoal-700 pt-4">
                  ...
                  <button
                    onClick={() => {
                      setSelectedPackage(svc);
                      setCheckoutOpen(true);
                    }}
                    className="font-sans text-xs tracking-widest uppercase text-cream-200 hover:text-gold-400 transition-colors cursor-pointer"
                  >
                    Book →
                  </button>
                </div>
